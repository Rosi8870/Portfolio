...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/roshinth-sojan-846880264?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@roshinth_sojan",
    icon: Instagram,
    url: "https://www.instagram.com/roshinth_sojan?igsh=MTVqbGlzbHFreHpqcw==?hl=id",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@roshinth_sojan",
    icon: Youtube,
    url: "https://www.youtube.com/@roshinth_sojan",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@roshinth-sojan",
    icon: Github,
    url: "https://github.com/Rosi8870",
    color: "#ffffff",
